      ...
      <div className="absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] w-full h-full max-w-[500px] p-4 md:h-auto">
        <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
          ...
          <div className="flex flex-col gap-[16px] px-6 py-6 lg:px-8">
            ...
            >
              <Form.Item
                className="text-[#1B1D21] text-[18px] font-medium mb-[18px]"
                label="Số Xu Cần Nạp"
                name="coin"
                id="coin"
              >
              ...
              <Row>
                <Col span={24} style={{ textAlign: 'right' }}>
                  <Button
                    htmlType="submit"
                    className="bg-black active:bg-black active:border-black active:text-white focus:bg-black focus:border-black focus:text-white  hover:bg-black hover:text-white hover:border-black text-white text-[14px] font-medium rounded-md w-[120px] h-[40px]"
                  >
                    Xác Nhận
                  </Button>
                </Col>
